...
class FetchTracker:
    ...
    def should_fetch(self, team_name: str) -> bool:
        ...
        recheck_hours = self._get_recheck_hours(next_match, now)
    ...
    def _get_recheck_hours(self, next_match: datetime | None, now: datetime) -> float:
        ...
        days_until_match = (next_match - now).total_seconds() / 86400
    ...
    def record_fetch(self, team_name: str, next_match: datetime | None) -> None:
